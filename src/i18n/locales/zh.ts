...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    selectionChat: {
      quickActionsTitle: 'Cursor 指令',
      quickActionsDesc: '自定义选中文本后显示的 Cursor 指令和提示词',
      configureActions: '配置 Cursor 指令',
      actionsCount: '已配置 {count} 个 Cursor 指令',
      addAction: '添加 Cursor 指令',
      resetToDefault: '恢复默认',
      confirmReset: '确定要恢复默认的 Cursor 指令吗？这将删除所有自定义设置。',
      resetConfirmTitle: '重置 Cursor 指令',
      actionLabel: '指令名称',
    ...
    agent: {
      ...
      skillsGlobalDesc:
        '技能会从 YOLO/skills/**/*.skill.md 自动发现。在这里禁用后，所有 Agent 都无法使用。',
      skillsSourcePath: '路径：YOLO/skills/**/*.skill.md',
      refreshSkills: '刷新',
      skillsEmptyHint: '未发现技能。请在 YOLO/skills 下创建 .skill.md 文件。',
      agents: 'Agents',
